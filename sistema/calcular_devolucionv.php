...
<body>
	...
	<div class="datos_cliente">	
		<div class="title_page">
			<h1><i class="fas fa-cube"></i>Calcular Devolución de Venta</h1>
		</div>
				
			<form name="form_new_cliente_venta" id="form_new_cliente_venta" class="datos" action="Devolverv.php"
...
if (mensaje) {
	window.location.href='registro_devolucionv.php';
}
