...
<head>
	...
	?>
	<title>Buscar Artículo Eliminado</title>
...
<body>
	...
	<section class="contenido">
			...
			<h1>Busqueda de Artículos Eliminados</h1>
            ...
            <table>
				...
				$sql_registe=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM recuperado 
										WHERE estatus=0 and (descripcion_recuperado LIKE '%$busqueda%' OR 
				...
				$total_paginas=ceil($total_registro/$por_pagina);
                    ...
                    $query=mysqli_query($conexion,"SELECT r.descripcion_recuperado, r.fecha_recuperado, p.descripcion, 
										...
										ON r.codproducto=p.codproducto WHERE r.estatus=0 and
