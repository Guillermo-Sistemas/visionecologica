<?php
    ...
    if(!empty($_POST))
    {
        ...
        if(empty($_POST['valor']) )
        {
            ...
            echo $tercero."aca".$valor2."aca".$tipogasto;
            ...
            $query_gasto=mysqli_query($conexion, "UPDATE gasto SET idtipogasto=$tipogasto, idcliente=$tercero, 
                        valorgasto=$valor2, nota='$nota2', IDUSUARIO=$iduser, estatus=3  WHERE idgasto=$idgasto");
	...
	<section id="container">
        <div class="form_register">
            ...
            <form action="" method="post">
                ...
                <label for="nota">Procedencia</label>
                <input type="text" name="procedencia" id="procedencia" placeholder="PROCEDENCIA" value="<?php echo $procedencianombre; ?>">
                </select>
