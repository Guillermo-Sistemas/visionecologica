        ...
        if(empty($_POST['valor']) )
        {
            ...
            if ($tipo==1){
                ...
                $queryentrada=mysqli_query($conexion, "INSERT INTO salida(idcaja, fecha, valorsalida, tiposalida,descripcion_s)
                                            VALUES ('$controlcaja','$fechaactual2','$pagado', 1 ,'Abono Factura .$nofactura')") ;
            }else {
...
<head>
	...
	?>
	<title>Pagar Compra Crédito Administrador</title>
...
<body>
	...
	<section id="container">
        <div class="form_register">
            <h1>Pagar Compra a Crédito Administrador</h1>
            <hr>
            ...
            <form action="" method="post">
                ...
                <input type="button" onclick=" location.href='listar_compra_credito.php' " value="Cancelar" name="boton" class="btn_cancelado"  />
                 <?php
