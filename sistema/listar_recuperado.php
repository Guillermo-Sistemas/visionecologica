...
<body>
	...
	<section class="contenido">
            ...
            <table>
				...
				$sql_registe=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM recuperado WHERE estatus=1 " );
				...
				$total_paginas=ceil($total_registro/$por_pagina);
                    ...
                    $query=mysqli_query($conexion,"SELECT r.codrecuperado, r.descripcion_recuperado, r.fecha_recuperado, p.descripcion, 
													...
													INNER JOIN producto p ON r.codproducto=p.codproducto
                   									WHERE r.estatus=1 ORDER BY r.fecha_recuperado ASC LIMIT $desde, $por_pagina" );
