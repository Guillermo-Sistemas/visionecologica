<?php
	...
	//SE GENERA devolucion
		$query_devolucion=mysqli_query($conexion, "INSERT INTO devolucionc (fechadevc, usuario, codcliente, total_devc, motivo)
                                VALUES ('$fechaactual2','$iduser','$idcliente','$total', '$motivo')");
								
		//ultima devolucion
		$numdevolucion=mysqli_query($conexion, "SELECT MAX(nodevolucionc) from devolucionc");
	...
	if (!empty($_POST['idproducto0'])){
		...
		$query_producto0 = mysqli_query($conexion, "INSERT INTO detalledevc (nodevolucionc, 
	...
	if (!empty($_POST['idproducto1'])){
		...
		$query_producto1 = mysqli_query($conexion, "INSERT INTO detalledevc (nodevolucionc, 
										nomproducto, cantidad, valorkilo,  subtotal)
	...
	if (!empty($_POST['idproducto2'])){
		...
		$query_producto2 = mysqli_query($conexion, "INSERT INTO detalledevc (nodevolucionc, 
								nomproducto, cantidad, valorkilo,  subtotal)
	...
	if (!empty($_POST['idproducto3'])){
		...
		$query_producto3 = mysqli_query($conexion, "INSERT INTO detalledevc (nodevolucionc, 
								nomproducto, cantidad, valorkilo,  subtotal)
	 ...
	 if (!empty($_POST['idproducto4'])){
		...
		$query_producto4 = mysqli_query($conexion, "INSERT INTO detalledevc (nodevolucionc, 
							nomproducto, cantidad, valorkilo,  subtotal)
...
if (!empty($_POST['idproducto5'])){
	...
	$query_producto5 = mysqli_query($conexion, "INSERT INTO detalledevc (nodevolucionc, 
									nomproducto, cantidad, valorkilo,  subtotal)
...
<body>
	...
	<div class="datos_cliente">	
		...
		<div class="wd30"><a href="facturadevc_pdf.php" target="_blank">
