...
<head>
	...
	?>
	<title>Lista de Compras a Crédito Pagadas Administrador</title>
...
<body>
	...
	<section class="contenido">
			<h1>Lista de Compras a Crédito Pagadas Administrador</h1>
            ...
            <table>
				...
				$sql_registe=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM factura WHERE estatus=2 
										and tipofactura=2 " );
				...
				$total_paginas=ceil($total_registro/$por_pagina);
                    ...
                    factura f INNER JOIN cliente c ON f.codcliente=c.idcliente  WHERE f.estatus=2 and tipofactura=2  ORDER BY 
