...
<head>
	...
	?>
	<title>Lista de Ventas Crédito</title>
...
<body>
	...
	<section class="contenido">
			<h1>Lista de Ventas a Crédito por Cobrar Administrador</h1>
		    ...
		    <th>Acciones</th>
				...
				$sql_registe=mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM facturaV
													 WHERE estatus=1 and tipofactura=2" );
				...
				$total_paginas=ceil($total_registro/$por_pagina);
                    ...
                    $query=mysqli_query($conexion,"SELECT f.nofacturav, f.fecha, f.abono, f.totalfactura, c.nit, c.nombrec  FROM
													...
													WHERE f.estatus=1 and tipofactura=2
				...
				?>
						<tr>
							...
							<td>
								...
								id=<?php echo $data["nofacturav"]; ?>"><i class="fas fa-trash-alt"></i>Anular Venta</a>
								|
								
									<a class="link_delete" href="cobrar_venta_credito.php? 
									id=<?php echo $data["nofacturav"]; ?>"><i class="fas fa-dollar-sign"></i>Cobrar Venta</a>	
