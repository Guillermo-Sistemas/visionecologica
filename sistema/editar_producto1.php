	...
	<section id="container">
        <div class="form_register">
            ...
            <form action="" method="post">
                ...
                <input type="number" name="existencia" id="existencia" readonly  placeholder="existencia" value="<?php echo $existencia; ?>">
                
                <input type="submit" value="Actualizar Producto" class="btn_save">
		        <input type="button" onclick=" location.href='listar_producto.php' " value="Cancelar" name="boton" class="btn_cancelado"  />
